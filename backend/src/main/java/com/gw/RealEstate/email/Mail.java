...
import com.gw.RealEstate.Entity.Contact;
...
public class Mail {
	...
	public static String send(String to){
	 ...
	 public static void sendQuery(Contact contact){
...
//			 String otpvalue=otp.OTP(4);
		   ...
		   message.addRecipient(Message.RecipientType.TO,new InternetAddress("greatwitsservices@gmail.com"));  
		   message.setSubject(contact.getSubject());  

		    BodyPart messageBodyPart1 = new MimeBodyPart();  
		    messageBodyPart1.setText("Full Name : "+contact.getFullname());
			
		    BodyPart messageBodyPart2 = new MimeBodyPart();  
		    messageBodyPart2.setText("Phone Number : "+contact.getPhone());

		    BodyPart messageBodyPart3 = new MimeBodyPart();  
		    messageBodyPart3.setText("Message : "+contact.getMessage());
