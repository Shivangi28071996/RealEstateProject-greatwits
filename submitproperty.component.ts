...
newSub(propertyDetail:SubmitDetails){
  ...
  this.newProperty=new SubmitDetails(propertyDetail.title.toUpperCase(),propertyDetail.propStatus,propertyDetail.type,propertyDetail.price,propertyDetail.area,propertyDetail.rooms,this.newProperty.bathroom,this.newProperty.address.toUpperCase(),this.newProperty.postalcode,this.newProperty.info.toUpperCase(),this.newProperty.name.toUpperCase(),this.newProperty.email,this.newProperty.phone,this.newProperty.parking,this.newProperty.ac,this.newProperty.image,
  propertyDetail.balcony,propertyDetail.pool,propertyDetail.storage,propertyDetail.gaspipe,propertyDetail.alarm,propertyDetail.pooja,propertyDetail.laundry,propertyDetail.city,this.newProperty.state,this.newProperty.buildingage,this.newProperty.floor,this.newProperty.noofparking,this.newProperty.furnished,this.newProperty.view,this.newProperty.location.toUpperCase(),this.newProperty.propertyStat);
  ;
